 ...
 * the current location focus. Accepting re-centers the focus; the X dismisses
 * for the session. Self-contained: surfaces just pass the focus coords.
 */
  ...
  return (
    <View style={styles.pill}>
      ...
      <Pressable
        ...
        accessibilityLabel={`Set location to ${suggestion.label}`}
      >
        {setFocus.isPending ? (
