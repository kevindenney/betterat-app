...
function AuthGate() {
  ...
  useEffect(() => {
    ...
    const publicSegments = ['index', '(auth)', 'privacy', 'welcome', 'callback', 'blueprint', 'community', 'pricing', 'institutions', 'how-it-works', 'share', 'dev', 'auth-welcome-ios', 'redeem', 'officiating', 'sports-photography'];
