...
type GapPreset = '1night' | '3day' | 'week' | '2month';
...
function buildMockDays(gapDays: number): HingeDay[] {
  const days: HingeDay[] = [];
...
function mockHinge(preset: { id: GapPreset; days: number }): BuiltHinge {
  return {
    ...
    days: buildMockDays(preset.days),
  };
}
...
export default function Phase9Debug() {
  ...
  return (
    <View style={styles.screen}>
      <Stack.Screen options={{ title: 'Phase 9 · Hinge demo' }} />
