...
| B.11 | Do tab interior: pre-activity capture affordances, live capture stream, post-activity summary, Move-to-Reflect handoff, and evidence marking. | `specs/PHASE_B11_DO_TAB_INTERIOR_SPEC.md`, `PRACTICE_TIMELINE_CANONICAL.md` | `do-tab-interior-canonical.html` | spec-written | 7 | B.5 complete; blocks full B.10 Reflect end-to-end verification | `PRACTICE_DO_TAB_IOS_REGISTER=false` |
...
| `PHASE_B11_DO_TAB_INTERIOR_SPEC.md` | Do tab interior, live capture stream, post-activity summary, Move-to-Reflect handoff, evidence marking. | written |
